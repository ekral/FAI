...
Třídy nejsou součástí C11, proto zde používáme C++23. `std::string` odpovídá řetězci v Pythonu, protože alokuje a uvolňuje paměť pro řetězec automaticky a `this` odpovídá `self` v Pythonu.

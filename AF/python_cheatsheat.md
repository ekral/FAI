...
1. **Píše to "Semicolon expected"?** Chybí ti ; na konci řádku.
2. **Píše to "The name '...' does not exist in the current context"?** Zkontroluj velká/malá písmena (C# je case-sensitive) nebo zda máš správný using.

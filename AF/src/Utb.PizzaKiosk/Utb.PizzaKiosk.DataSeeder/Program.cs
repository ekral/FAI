...
context.Ingredients.AddRange(
    new Ingredient { Id = 1, Name = "Tomato", UnitPrice = 10.0m, Unit = IngredientUnit.Gram, UnitQuantity = 80, AlergensList = "[1,2,3]" },
    new Ingredient { Id = 2, Name = "Ananas", UnitPrice = 25.0m, Unit = IngredientUnit.Gram, UnitQuantity = 80, AlergensList = "[5,6]" });
